...
import cn.kuailaimei.store.login.ui.LoginActivity;
import cn.kuailaimei.store.login.ui.ModifyPassWordActivity;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.modify_psd_layout:
                //修改密码
                if(User.get().notLogin()){
                    LoginActivity.launch(this,false,User.get().getFlag());
                }else{
            ...
            case R.id.login_out_btn:
                ...
                commonDialog.setOnPositiveButtonClickListener(new CommonDialog.OnPositiveButtonClickListener() {
                    ...
                    public void onClick(Dialog dialog) {
                        ...
                        EventBus.getDefault().post(new EventFactory.CloseAll());
                        LoginActivity.launch(SettingActivity.this,true,User.get().getFlag());
                    }
                });
                commonDialog.show();
                break;

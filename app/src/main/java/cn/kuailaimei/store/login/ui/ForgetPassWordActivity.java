...
import cn.kuailaimei.store.api.request.ResetPsdRequest;
import cn.kuailaimei.store.api.request.VerifyCodeRequest;
import cn.kuailaimei.store.common.ui.ValidateActivity;
...
public class ForgetPassWordActivity extends ValidateActivity {
    ...
    public static void launch(Activity act){
        Intent intent = new Intent(act,ForgetPassWordActivity.class);

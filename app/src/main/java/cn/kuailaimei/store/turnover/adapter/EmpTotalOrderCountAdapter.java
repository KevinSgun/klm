 ...
 */
public class EmpTotalOrderCountAdapter extends ListAdapter<AmountItem> implements IDataAdapter<List<AmountItem>> {
    public EmpTotalOrderCountAdapter(Context context, ArrayList<AmountItem> amountItems) {
        super(context);
        mList = amountItems;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(item != null){
            ...
            if(User.get().isBoss()){
                ...
                stafftv.setVisibility(View.GONE);
            }

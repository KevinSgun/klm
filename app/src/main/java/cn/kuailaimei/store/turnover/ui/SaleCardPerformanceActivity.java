 ...
 */
public class SaleCardPerformanceActivity extends AppBarActivity {
    ...
    protected int getContentViewId() {
        return R.layout.activity_sale_card_performance_list;
    }

    @Override
    protected void initView() {
        setTitle(R.string.sale_card_performance);
        slidingtabs = (SlidingTabs) findViewById(R.id.sliding_tabs);
        pager = (ViewPager) findViewById(R.id.pager);
        String[] titles = { "7天", "30天", "全部"};

        this.fragments = new LinkedList<>();
        SaleCardPerformanceFragment fragment0 = SaleCardPerformanceFragment.getInstance("7");
        SaleCardPerformanceFragment fragment1 = SaleCardPerformanceFragment.getInstance("30");
        SaleCardPerformanceFragment fragment2 = SaleCardPerformanceFragment.getInstance("");
    ...
    public static void launch(Activity act){
        Intent intent = new Intent(act,SaleCardPerformanceActivity.class);

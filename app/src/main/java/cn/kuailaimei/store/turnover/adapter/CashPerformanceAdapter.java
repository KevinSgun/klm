 ...
 */
public class CashPerformanceAdapter extends ListAdapter<AmountItem> implements IDataAdapter<List<AmountItem>> {

    public CashPerformanceAdapter(Context context, ArrayList<AmountItem> amountItems) {
        super(context);
        mList = amountItems;
    }

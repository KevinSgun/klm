package cn.kuailaimei.store.common.widget.timepicker;
...
import cn.kuailaimei.store.common.widget.timepicker.view.BasePickerView;
import cn.kuailaimei.store.common.widget.timepicker.view.WheelTime;
...
//        minute = (minute<59?(minute+1):minute);
     ...
     * 设置选中时间，且该时间为最小可选时间
     * @param date
     * @deprecated  暂时不对时间范围作限制，直接使用setTime(Date date)
     */

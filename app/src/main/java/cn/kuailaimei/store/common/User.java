package cn.kuailaimei.store.common;
...
public class User {
    ...
    private int flag;//0普通员工，1老板，2会员

    public static User get() {

        return StoreApplication.getInstance().getUser();
    }
    public User() {
        super();
        sp = new SP("USER_DATA");
    ...
    public void storeFlag(int flag) {
        this.flag = flag;
        sp.putInt(FLAG, flag);
    }

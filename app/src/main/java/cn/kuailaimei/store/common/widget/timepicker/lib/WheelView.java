package cn.kuailaimei.store.common.widget.timepicker.lib;
...
import cn.kuailaimei.store.common.widget.timepicker.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    private static final String GET_NAME = "getName";//反射的方法名

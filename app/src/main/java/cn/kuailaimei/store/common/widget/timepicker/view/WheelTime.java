package cn.kuailaimei.store.common.widget.timepicker.view;
...
import cn.kuailaimei.store.common.widget.timepicker.adapter.NumericWheelAdapter;
import cn.kuailaimei.store.common.widget.timepicker.lib.WheelView;
import cn.kuailaimei.store.common.widget.timepicker.listener.OnItemSelectedListener;
...
public class WheelTime {
    ...
    private int textSize = 4; //字体大小设置


    private TimePickerView.Type type;
    private int START_YEAR = 2000, END_YEAR = 2016;
